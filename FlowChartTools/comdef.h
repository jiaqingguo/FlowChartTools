...
enum class LINE_HEAD_TYPE{ARROW0 = 0,ARROW1,ARROW2,ARROW3,ARROW4};
    // 图形类型             无   矩形  菱形      圆角矩形    圆形  线性  梯形       五角星形
enum class PaintChartType{NONE,RECT,DIAMOND,ROUNDRECT,ELLIPSE,LINE,TRAPEZOID,PENTAGRAM,RECT_MY,BLOCK};
